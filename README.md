...
Happy Chat now supports email/password accounts with:
- Full name
- Username
- Email address
...
- Editable full name, username and bio

Before deployment, enable **Email/Password** in Firebase Console → Authentication → Sign-in method. The web Firebase configuration is already present in `index.html` for the Opinion Firebase project.
